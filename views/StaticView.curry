...
landingPage = 
  ...
  ,(container `withId` "landing-page")
    [row
      [col [Md 4]
        [img [src "images/smap-ie.png",class "img-circle"]
        ,h3 [] [glyphicon "edit",text " SmapIE"]
        ,text smapIEInfo]
      ,col [Md 4]
        [img [src "images/browser.png",class "img-circle"]
        ,h3 [] [glyphicon "list",text " Browser"]
        ,text browserInfo]
      ,col [Md 4]
        [img [src "images/users.png",class "img-circle"]
      ...
      [col [Xs 8,XsOffset 2]
        [panelDefault
          [panelBody
            ...
            ,row
              [col [Xs 2]
                [a [href curryUrl,class "thumbnail",targetBlank]
                  [img [src "images/curry.png",alt "Curry"]]]
              ,col [Xs 2]
                [a [href spiceyUrl,class "thumbnail",targetBlank]
                  [img [src "images/spicey.png",alt "Spicey"]]]
              ,col [Xs 2]
                [a [href codemirrorUrl,class "thumbnail",targetBlank]
                  [img [src "images/codemirror.png",alt "CodeMirror"]]]
              ,col [Xs 2]
                [a [href bootstrapUrl,class "thumbnail",targetBlank]
                  [img [src "images/bootstrap3.png",alt "Bootstrap 3"]]]
              ,col [Xs 2]
                [a [href glyphiconsUrl,class "thumbnail",targetBlank]
