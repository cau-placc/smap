      ...
      [col [Xs 8,XsOffset 2]
        [panelDefault
          [panelBody
            ...
            ,row
              [col [Xs 2]
                [a [href curryUrl,class "thumbnail"]
                  [img [src "images/curry.png",alt "Curry"]]]
              ,col [Xs 2]
                [a [href spiceyUrl,class "thumbnail"]
                  [img [src "images/spicey.png",alt "Spicey"]]]
              ,col [Xs 2]
                [a [href codemirrorUrl,class "thumbnail"]
                  [img [src "images/codemirror.png",alt "CodeMirror"]]]
              ,col [Xs 2]
                [a [href bootstrapUrl,class "thumbnail"]
                  [img [src "images/bootstrap3.png",alt "Bootstrap 3"]]]
              ,col [Xs 2]
                [a [href glyphiconsUrl,class "thumbnail"]
